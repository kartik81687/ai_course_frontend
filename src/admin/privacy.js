...
const Privacy = () => {
    ...
    const [content, setContent] = useState(sessionStorage.getItem('privacy') || '');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                sessionStorage.setItem('privacy', content);
                showToast(response.data.message);
            }
        } catch (error) {
            showToast('Failed to save privacy policy');
        }
            ...
            <div className="md:hidden relative z-10">
                <div className="bg-luxury/50 backdrop-blur-md border-b border-white/10">
                    <div className="flex items-center justify-between px-4 py-4">
                        <h1 className="text-[#FFD700] text-xl font-black">Privacy Policy Management</h1>
                        <button 
                        ...
                        <div className="card-luxury p-6 rounded-xl">
                            <div className="mb-4">
                                <p className="text-white/70">
                                    Edit your privacy policy content below. Use HTML formatting for better presentation.
                                </p>
                            </div>
                            <div className="relative">
                                <textarea
                                    ...
                                    placeholder="Enter your privacy policy content in HTML format..."
