...
const Billing = () => {
    ...
    const [content, setContent] = useState(sessionStorage.getItem('billing') || '');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                sessionStorage.setItem('billing', content);
                showToast(response.data.message);
            }
        } catch (error) {
            showToast('Failed to save billing policy');
        }
            ...
            <div className="md:hidden relative z-10">
                <div className="bg-luxury/50 backdrop-blur-md border-b border-white/10">
                    <div className="flex items-center justify-between px-4 py-4">
                        <h1 className="text-[#FFD700] text-xl font-black">Billing Policy Management</h1>
                        <button 
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center space-x-3">
                                <div className="bg-[#FFD700]/10 p-3 rounded-xl">
                                    <FaCreditCard className="text-[#FFD700] text-2xl" />
                                </div>
                        ...
                        <div className="card-luxury p-6 rounded-xl">
                            <div className="mb-4">
                                <p className="text-white/70">
                                    Edit your billing policy content below. Use HTML formatting for better presentation.
                                </p>
                            </div>
                            <div className="relative">
                                <textarea
                                    ...
                                    placeholder="Enter your billing policy content in HTML format..."
