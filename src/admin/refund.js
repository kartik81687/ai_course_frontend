...
const Refund = () => {
    ...
    const [content, setContent] = useState(sessionStorage.getItem('refund') || '');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                sessionStorage.setItem('refund', content);
                showToast(response.data.message);
            }
        } catch (error) {
            showToast('Failed to save refund policy');
        }
            ...
            <div className="md:hidden relative z-10">
                <div className="bg-luxury/50 backdrop-blur-md border-b border-white/10">
                    <div className="flex items-center justify-between px-4 py-4">
                        <h1 className="text-[#FFD700] text-xl font-black">Refund Policy Management</h1>
                        <button 
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center space-x-3">
                                <div className="bg-[#FFD700]/10 p-3 rounded-xl">
                                    <FaMoneyBillWave className="text-[#FFD700] text-2xl" />
                                </div>
                        ...
                        <div className="card-luxury p-6 rounded-xl">
                            <div className="mb-4">
                                <p className="text-white/70">
                                    Edit your refund policy content below. Use HTML formatting for better presentation.
                                </p>
                            </div>
                            <div className="relative">
                                <textarea
                                    ...
                                    placeholder="Enter your refund policy content in HTML format..."
